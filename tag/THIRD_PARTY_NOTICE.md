...
License and other copyright information for each gem is included in the image at `/usr/local/lib/ruby/gems/2.5.0/gems/{gem}`

More information about each package can be found at `https://rubygems.org/gems/{gem}`
